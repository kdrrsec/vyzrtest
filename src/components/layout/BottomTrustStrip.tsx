...
function BoxIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-10 w-10 text-white/60" aria-hidden>
      <path
...
export async function BottomTrustStrip() {
  ...
  return (
    <section className="border-t border-white/15 py-8">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((item) => (
            <div key={item.title} className="text-center lg:text-left">
              ...
              <h3 className="mt-2 text-sm font-semibold uppercase tracking-[0.08em] text-white">
                {item.title}
              </h3>
