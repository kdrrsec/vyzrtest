      ...
      <form action={formAction} className="mt-10 space-y-4">
        ...
        <FieldGroup htmlFor="comment" label={t("comment")}>
          <textarea
            ...
            name="comment"
            rows={6}
            className="min-h-[140px] w-full resize-y border-0 bg-transparent py-1 text-sm text-foreground caret-foreground outline-none ring-0 placeholder:text-muted focus:ring-0"
          />
        </FieldGroup>
